...
// Camera
Camera camera(glm::vec3(20.0f, 8.0f, 0.0f));
bool keys[1024];
...
int main()
{
  ...
  //      centro.Draw(lightingShader);
		...
		//glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.25f, 0.25f, 0.25f);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(1.0f + movelightPosX,1.0f + movelightPosY,1.0f + movelightPosZ));
